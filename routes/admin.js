...
router.post("/announce-winner", (req, res) => {
    ...
    const output = `<div class="container">
        <div style="color:black;background-color: white">
                       ...
                       <ul>
                            <li>Click On Cart button top right on the Home Page</li>
                            <li>Click on BUY NOW button</li>
                            <li>Make payment and get your product</li>
                       </ul>
                       <h3 style="color: red"><b>NOTE:-</b></h3>
                       <h3 style="color: red">Please, Buy your Product with in 7 Days after week Bid will be cancelled</h3>
                       <h4>Thanks,</h4>
                       <h3>Team BidWorx</h3>
        </div>
    </div>`;
    ...
    const mailOptions = {
        ...
        to: email,
        subject: 'Winners announced - BidWorx Best Places to Bidding Awards 2022!',
        text: `Hello !`,
        html: output
    };
